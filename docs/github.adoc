...
The URL for the GIT repository is https://github.com/oceanborn2/git-training.git[]

.Let's try first from the command line

[source, bash]
----
git clone https://github.com/oceanborn2/git-training.git
# /d/co % git clone https://github.com/oceanborn2/git-training.git
...
gh repo clone oceanborn2/git-training
